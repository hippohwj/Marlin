#ifndef ARBORETUM_SRC_TRANSPORT_RPC_CLIENT_H_
#define ARBORETUM_SRC_TRANSPORT_RPC_CLIENT_H_
...
public:
    ...
    RC sendRequestAsync(ITxn * txn, uint64_t node_id,
...
#endif //ARBORETUM_SRC_TRANSPORT_RPC_CLIENT_H_